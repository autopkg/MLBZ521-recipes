...
#
# Modified by Zack Thompson for use with the Cisco Jabber vendor created package.
#
...
"""See docstring for CiscoJabberVersioner class"""
...
__all__ = ["CiscoJabberVersioner"]
__version__ = '1.1'

class CiscoJabberVersioner(Processor):
    ...
    def main(self):
        ...
        if not os.path.exists(dist_path):
            ...
            try:
                bundle = root.findall('./pkg-ref[@id="com.cisco.Jabber"]/bundle-version/bundle')
                version = bundle[0].get('CFBundleShortVersionString')
...
if __name__ == '__main__':
    PROCESSOR = CiscoJabberVersioner()
